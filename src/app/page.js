  ...
  return (
    <main className={styles.main}>
      <div className={styles.announcementBanner}>
        <p>📢  NEW MEMBERS: Make sure to fill out the club signup form <a href="https://docs.google.com/forms/d/e/1FAIpQLSdEjhuI1HppdYNX4lgr19UALhSscOlOk1ggNZXmZLF26QgO7w/viewform">HERE</a>!</p>
      </div>
